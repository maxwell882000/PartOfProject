...
namespace VitcAuth.Controllers.Moderator.Kasb
{
    ...
    public class JobModeratorGroupController : ApiBaseController
    {
        ...
        public JobModeratorGroupController(IGroupRepository groupRepository, IUserRepository userRepository, IMapper mapper)
        {
            ...
            return Ok(
                new
                {
                    ...
                    .Select(e => new
                    {
                        ...
                        (double)(e?.Profile?.LastPrice) - e.BranchStudentPayments.Where(e => e.Status == 1).Sum(e => e.PaidPrice) +
                        e.BranchStudentPayments.Where(e => e.Status == 2).Sum(e => e.PaidPrice) > 0),
